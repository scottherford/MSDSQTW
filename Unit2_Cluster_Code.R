...
options(digits = 2)
txt <- "Home/Downloads/CaseSudy_2_Code/offline.final.trace.txt"
...
readData = 
  function(filename = '~/Desktop/offline.final.trace.txt', 
...
online = readData("~/Desktop/online.final.trace.txt", subMacs = macs)
